...
const _sfc_main = {
  ...
  data() {
    return {
      imageSrc: store_index.store.getters.avatar,
      isShowImg: false,
      // 初始化的宽高
      ...
      ctx.draw(true, () => {
        ...
        common_vendor.index.canvasToTempFilePath({
          ...
          success: function(res) {
            ...
            api_system_user.uploadAvatar(data).then((response) => {
              store_index.store.commit("SET_AVATAR", baseUrl + response.imgUrl);
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/chaochen/Desktop/manyou/haohaomanyoufront/pages/mine/avatar/index.vue"]]);
